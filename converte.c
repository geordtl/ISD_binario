...
int main (void){
    ...
    /* operações */
    mod, soma, sub, sub2, potDec = 1, potHex = 1, totSoma[9], totSub[9], comp2, totComp2[9], n1Dec, n1Hex, soma1Dec = 0, soma1Hex = 0;
    char n1[9], n1s[9], n1Sub[9], n2[9], n2s[9], operacao, somaChar[9], subChar[9], comp2C[9];
