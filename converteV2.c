...
int main(void)
{
	int i,
	/* auxiliares */
	n1c, n2c, n1qtd, n2qtd, qtdDigitos, qtdDigitos2, tempSoma = 0,
	...
	scanf("%8s", n1);
	if(strcmp(n1, "-1") == 0) return 0;
	else {
	    n1qtd = strtol(n1, NULL, 10);
    	n1c = n1qtd;
    
    	qtdDigitos = strlen(n1);
    	for (i = 0; i < (8 - qtdDigitos); i++)
    	{
    		numero1[i] = 0;
    	}
    
    	for (i = (8 - qtdDigitos); i < 8; i++)
    	{
    		numero1[i] = (int)n1[i - (8 - qtdDigitos)];
    		...
    		qtdDigitos2 = strlen(n2);
    		if (operacao == '+' || operacao == '-')
    		{
    			for (i = 0; i < (8 - qtdDigitos2); i++)
    			{
    				numero2[i] = 0;
    			}
    
    			for (i = (8 - qtdDigitos2); i < 8; i++)
    			{
    				numero2[i] = (int)n2[i - (8 - qtdDigitos2)];
